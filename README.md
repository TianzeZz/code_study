...
1-4|2022-2-18|**双指针**|字符串，翻转|344. 反转字符串（简单） , 557. 反转字符串中的单词 III(小改动，增加查找空格)
2-1|2022-2-16|**动态规划**|将抽象问题拟合为递推问题，爬楼梯|746.使用最小花费爬楼梯 , 70.爬楼梯
2-2|2022-2-17|**动态规划**|跳一或者跳二，依旧递推|198. 打家劫舍(巧妙将跳二问题转化，具体见解释) , 213. 打家劫舍 II , 740. 删除并获得点数（利用哈希表）
2-3|2022-2-18|**动态规划**|跳跃游戏，动态查找最大|55. 跳跃游戏(遍历确定单步最远到达) , 45. 跳跃游戏 II（下步最远距离获得最小次数）
